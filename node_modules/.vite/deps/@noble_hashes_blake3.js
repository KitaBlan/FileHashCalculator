import { _ as u32, a as anumber, d as createXOFer, g as toBytes, m as swap32IfBE, n as abytes, o as aoutput, r as aexists, s as clean, v as u8 } from "./utils-LgUxJG_x.js";
import { o as compress, t as BLAKE2 } from "./blake2-DH5I_eW3.js";
import { a as SHA256_IV } from "./_md-IDB4pQI2.js";
import { c as fromBig } from "./_u64-B_h9R7Zx.js";
//#region node_modules/@noble/hashes/esm/blake3.js
/**
...
var BLAKE3 = class BLAKE3 extends BLAKE2 {
	...
	finish() {
		...
		if (this.stack.length) {
			...
			this.chunksDone = 0;
			this.pos = this.blockLen;
		} else flags |= (!this.chunkPos ? B3_Flags.CHUNK_START : 0) | B3_Flags.CHUNK_END;
		this.flags = flags;
		this.b2CompressOut();
	}
	writeInto(out) {
...
//#endregion
export { BLAKE3, blake3 };

//# sourceMappingURL=@noble_hashes_blake3.js.map